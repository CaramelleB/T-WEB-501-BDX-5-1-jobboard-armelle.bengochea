import { getCompRecruiter } from '../services/api'
import { userId } from '../services/url'

export default class SelectCompany extends HTMLElement {
    ...
    constructor() {
        ...
        this.getAllData = async () => {
            const res = await getCompRecruiter(userId);
            this.data = res.data;
        }
        this.shadow.innerHTML += `
          <select name="company_id" style='${this.style().input}'>
