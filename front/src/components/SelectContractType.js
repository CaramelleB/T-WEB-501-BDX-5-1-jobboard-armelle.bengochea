...
export default class SelectContractType extends HTMLElement {
    ...
    constructor() {
        ...
        this.shadow.innerHTML += `
          <select name="contract_type_id" style='${this.style().input}'>
    ...
    async connectedCallback() {
      ...
      option(data, index) {
        return  `
        <option value="${data.id}">${data.contract_type_name}</option>
        `
        }
